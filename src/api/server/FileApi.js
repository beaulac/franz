...
import { removeServicePartitionDirectory } from '../../helpers/service-helpers.js';
...
export default class FileApi {
  ...
  async updateUserInfo(data) {
    await fs.writeFile(`${__dirname}/test.json`);

    const user = Object.assign({}, { data: new UserModel(data) });
  ...
  async searchRecipePreviews(needle) {
    const request = await window.fetch(`${SERVER_URL}/${API_VERSION}/recipes/search?needle=${needle}`,
